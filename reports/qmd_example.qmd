...
We present the standard deviations in @tbl-stddev.
...
Additionally, note that in @tbl-stddev we consider the sample standard deviation of the number of horses during the same time span as @fig-horse-pops.
